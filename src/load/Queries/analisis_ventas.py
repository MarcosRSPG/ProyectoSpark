...
bucket_path_csv = "s3a://data-lake/csv_processed/part-00000-1105766e-0009-4eb8-9e49-2b099c203bed-c000.csv"
df_csv = spark.read.option('header', 'true').option("delimiter", ",").csv(bucket_path_csv)

bucket_path_db = "s3a://data-lake/db_processed/part-00000-523b4613-8175-4bd4-9fc3-22726749cd2c-c000.csv"
df_db = spark.read.option('header', 'true').option("delimiter", ",").csv(bucket_path_db)

bucket_path_kafka= "s3a://data-lake/kafka_processed/part-00000-9cfec979-5c15-4208-8870-ea39f2c49756-c000.csv"
...
print('Tienda con mas beneficios de venta: \n')
